            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body table-responsive p-3 overflow-hidden ">
                        <form method="POST" action="{{ url('/admin/user/update/') }}" class="form-horizontal">
                            @csrf
                            @method('PUT')
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input name="phone" class="form-control" type="number"  value="{{ $user->phone }}" placeholder="Phone Number" required>
                                <span id="phone_error"></span>
                            </div>
                            <div class="form-group">
                                <span class="input-icon"><i class="fa fa-tasks"></i> Role</span>
                                <select name="role" id="role" class="form-control" required>
                                    <option value="" @if($user->role == '') selected @endif >--select--</option>
